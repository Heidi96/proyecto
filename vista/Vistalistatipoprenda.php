        ...
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                        ...
                        <td><a href='editatipoprenda.php?cod=<?php echo $reg[0];?>' class="btn btn-success"><i class="bi bi-eraser"></i></a></td>
                            
                        <td><a href='eliminatipoprenda.php?cid=<?php echo $reg[0];?>' class="btn btn-danger"><i class="bi bi-trash"></i></a></td>
                <?php        
                    }
                ?>
            </tbody>
