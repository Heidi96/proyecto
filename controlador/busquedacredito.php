        ...
        if(isset($_GET['Buscar'])){
            ...
            while($r=mysqli_fetch_array($res)){
                ...
                <tr align="center" valign="middle">
                    ...
                    <td><a href='editacredito.php?cod=<?php echo $r[0];?>' class="btn btn-success">
                    <i class="bi bi-eraser"></i></a></td>
                        
                    <td><a href='eliminacredito.php?cid=<?php echo $r[0];?>' class="btn btn-danger">
